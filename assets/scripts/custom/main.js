...
(function ($) {
  ...
  $carousel.slick({
    ...
    asNavFor: ".slider-nav",
    prevArrow:
      "<button class='slick-prev slick-arrow' aria-label='Next' type='button' style=''><i class='icon-left'></i></button>",
    nextArrow:
      "<button class='slick-next slick-arrow' aria-label='Next' type='button' style=''><i class='icon-right'></i></button>",
